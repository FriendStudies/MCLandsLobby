...
public class AdvancedLicense {
    ...
    public boolean register() {
        ...
        log(0, "Verbindung zum License-Server wird hergestellt...");
        ValidationType vt = isValid();
        if (vt == ValidationType.VALID) {
            log(1, "Die License ist gültig.");
            log(0, "[]==========[License-System]==========[]");
            return true;
        } else {
            log(1, "Die License ist ungültig.");
            log(1, "Fehlgeschlagen mit dem Ergebnis von: " + vt.toString());
            log(1, "Das Plugin wurde deaktiviert.");
            log(0, "[]==========[License-System]==========[]");
